                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      className="bg-accent hover:bg-accent/90 text-accent-foreground font-medium py-3 px-8 rounded-full transition duration-300 text-lg w-full md:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
                    >
