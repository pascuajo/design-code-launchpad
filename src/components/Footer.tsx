  ...
  return (
    <footer className="w-full bg-gray-900 text-white py-16 px-4 footer" data-component="footer">
      <div className="max-w-7xl mx-auto">
        {/* Footer Navigation */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-16 md:ml-8">
          {/* Column 1: Logo with strapline underneath */}
          <div className="flex flex-col justify-end text-center md:text-left">
            <a href="/">
              <div className="h-24 mb-4 flex flex-col items-center md:items-start justify-center">
                <img 
          ...
          {/* Column 3: Additional Pages with Social Icons */}
          <div className="flex flex-col justify-end text-center md:text-left">
            <ul className="space-y-3 text-white">
              <li className="footer" style={liFont.getFontStyle()}>
              ...
              <li className="footer" style={liFont.getFontStyle()}>
                <div className="flex items-center justify-center md:justify-start gap-3">
                  ...
                  {/* Social Icons to the right of About Me */}
                  <a 
                    href="https://www.linkedin.com/in/joe-pascual/" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-6 h-6 bg-gray-800 rounded-full flex items-center justify-center hover:bg-yellow-500 transition-colors flex-shrink-0"
                  >
                  ...
                  >
                    ...
                    <div className="md:hidden text-white text-sm font-normal" style={{fontFamily: 'Arial, sans-serif'}}>
                      b
                    </div>
                  </a>
                </div>
          ...
          {/* Column 4: Contact CTA Only */}
          <div className="flex flex-col justify-end text-center md:text-left">
            <button 
              onClick={() => setIsModalOpen(true)}
              className="bg-yellow-300 hover:bg-yellow-600 text-accent-foreground font-medium py-2 px-4 rounded-full transition duration-300 text-sm whitespace-nowrap w-full md:w-auto"
