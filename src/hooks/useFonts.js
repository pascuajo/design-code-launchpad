...
import { getFont, currentFonts, updateFonts, resetFonts } from '../config/fonts';
export function useFonts(componentId, elementType) {
...
export function useFontManager() {
    ...
    const updateFont = (componentId, elementType, newFont) => {
